 ...
 * @author user
 */
public class gui_quizHistory extends javax.swing.JFrame {

    /**
     * Creates new form gui_home
     */
    public gui_quizHistory() {
        initComponents();
...
//        this.setSize(1960,1080);
    ...
    private void initComponents() {
        ...
        label_home.setText("QUIZ HISTORY");
        ...
        panel_menuLayout.setHorizontalGroup(
            ...
            .addGroup(panel_menuLayout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(label_home, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(gui_quizHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new gui_quizHistory().setVisible(true);
            }
        });
    }
